...
//		
//		cc.filterCountriesByContinent("Eurasia");
		//cc.filterCountriesByContinent("Africa");
	    
	    	CountryCatalogue cc = new CountryCatalogue();
	    	//cc.filterCountriesByContinent("Asia");
	    	//cc.findCountryWithSmallestArea();
	    	cc.findMostPopulousContinent();

			
		/* PrintWriter is buffered, that means that the text you're writing to it is stored in its internal 
		 buffer before being actually written to the file. So you need to call a close() method when you're done writing
*/	
